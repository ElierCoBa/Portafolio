...
{
    public partial class FormularioParaSolicitarPermisoDeCuatro : Form
    {
        public FormularioParaSolicitarPermisoDeCuatro(string elCarne)
        {
            InitializeComponent();
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(txtCarnePrimerEstudiante.Text) && !string.IsNullOrEmpty(txtApellido1PrimerEstudiante.Text) && !string.IsNullOrEmpty(txtApellido2PrimerEstudiante.Text)
                    ...
                    && !string.IsNullOrEmpty(txtNombre1SegundoEstudiante.Text) && !string.IsNullOrEmpty(txtCarneTercerEstudiante.Text) && !string.IsNullOrEmpty(txtApellido1TercerEstudiante.Text) && !string.IsNullOrEmpty(txtApellido2TercerEstudiante.Text)
                    && !string.IsNullOrEmpty(txtNombre1TercerEstudiante.Text) && !string.IsNullOrEmpty(txtCarneCuartoEstudiante.Text) && !string.IsNullOrEmpty(txtApellido1CuartoEstudiante.Text) && !string.IsNullOrEmpty(txtApellido2CuartoEstudiante.Text)
                    && !string.IsNullOrEmpty(txtNombre1CuartoEstudiante.Text))
                {
                    ...
                    if (elGestorDeOperaciones.EncontrarEstudianteExterno(txtCarneTercerEstudiante.Text) == false)
                    {
                        elGestorDeOperaciones.InsertarEstudiante(txtCarneTercerEstudiante.Text, txtApellido1TercerEstudiante.Text, txtApellido2TercerEstudiante.Text, txtNombre1TercerEstudiante.Text, txtNombre2TercerEstudiante.Text);
                    }
                    if (elGestorDeOperaciones.EncontrarEstudianteExterno(txtCarneCuartoEstudiante.Text) == false)
                    {
                        elGestorDeOperaciones.InsertarEstudiante(txtCarneCuartoEstudiante.Text, txtApellido1CuartoEstudiante.Text, txtApellido2CuartoEstudiante.Text, txtNombre1CuartoEstudiante.Text, txtNombre2CuartoEstudiante.Text);
                    }
                    ...
                    elGestorDeOperaciones.InsertarPermiso(txtCarne.Text, txtCarneTercerEstudiante.Text, DateTime.Parse(dtpFecha.Text), DateTime.Parse(dtpHoraDeIngreso.Text), DateTime.Parse(dtpHoraDeSalida.Text));
                    elGestorDeOperaciones.InsertarPermiso(txtCarne.Text, txtCarneCuartoEstudiante.Text, DateTime.Parse(dtpFecha.Text), DateTime.Parse(dtpHoraDeIngreso.Text), DateTime.Parse(dtpHoraDeSalida.Text));
