...
{
    public partial class FormularioParaSolicitarPermisosDeTres : Form
    {
        public FormularioParaSolicitarPermisosDeTres(String elCarne)
        {
            InitializeComponent();
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(txtCarnePrimerEstudiante.Text) && !string.IsNullOrEmpty(txtApellido1PrimerEstudiante.Text) && !string.IsNullOrEmpty(txtApellido2PrimerEstudiante.Text)
                ...
                && !string.IsNullOrEmpty(txtNombre1TercerEstudiante.Text))
            {
